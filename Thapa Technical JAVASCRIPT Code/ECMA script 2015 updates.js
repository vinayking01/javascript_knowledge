...
console.log(names.indexOf('thapa',3)); // it will start search inf from index 3 rd


//2. lastIndexof() - It gives the last occurence of the item in theat array. if element not found then returns -1
...
// 10. Crud Operation in Array 
    ...
    const new_months = months.splice(months.lenght-1,0,'april','may') // splice(index, count_of_elements_want_to_remove, data want to enter);
...
// 11. reduce() - This function execurtes the reducer function which takes four arguments.accumulator, current_vlaue,current index, source array,
...
console.log(result2);
    ...
    // 12. Map()  - it is also used as various methods for iterating to the array. Main purpose is to creating new array. eg - forEach(). But the main difference is map function can return the modified array and after iterating over every element whereas foraech function return undefined. It also doesn't change in orignal array.
